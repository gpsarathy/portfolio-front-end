...
export default function ThemeToggle() {
  ...
  function setThemeColor(theme: string) {
    ...
    document.documentElement.style.setProperty("--secondary-color", `var(--${theme}-secondary-color)`);
  ...
  return (<FormGroup>
    <FormControlLabel
      control={<MaterialUISwitch size='small' sx={{ m: 1 }} checked={checked} onChange={handleChange} />} label={''} />
  </FormGroup>)
